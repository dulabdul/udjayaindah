...
export const FloatingActions = () => {
  ...
  return (
    <div className='fixed bottom-6 right-6 z-40 flex flex-col gap-4 items-end'>
      ...
      {/* WhatsApp Floating */}
      <a
        href={`https://wa.me/${SITE_CONFIG.whatsapp}?text=Halo%20Admin%20UD%20Jaya%20Indah,%20saya%20ingin%20bertanya%20tentang%20produk...`}
        target='_blank'
        rel='noopener noreferrer'
        className='group flex items-center gap-3 p-4 bg-[#25D366] text-white rounded-full shadow-xl hover:bg-[#128C7E] transition-all hover:scale-105'
